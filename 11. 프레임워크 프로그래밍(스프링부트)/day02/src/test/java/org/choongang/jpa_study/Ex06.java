...
public class Ex06 {
    ...
    @Test
    void test2() {
       List<Member> members = memberRepository.findByEmailContainingAndUserNameContainingOrderByCreatedAtDesc("ser", "채");
    ...
    @Test
    void test4() {
        List<Member> members = memberRepository.getMembers("%ser%", "%도%");
        members.forEach(System.out::println);
    }
}
